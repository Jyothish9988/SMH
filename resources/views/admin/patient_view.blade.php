                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @if ($doctors->status == 1)
                                                        <td>Approved</td>
                                                        <td><a href="{{url('patient_reject',$doctors->id)}}" onclick="return reject()" class="btn btn-outline-danger">Reject</a></td>                               
                                                        
                                                    @elseif($doctors->status == 0)   
                                                    <td><a href="{{url('patient_approve',$doctors->id)}}" onclick="return approve()" class="btn btn-success">Approve</a></td>                          
